    ...
    function ($scope, $http, $window, $filter) {
            ...
            if (result == true) {
              ...
              $http({
                ...
                data: {
                  ...
                  // vpobservacion: $scope.form1.observacionesPrincipal,
                  vpaccion: "I",
      ...
      $scope.p_obtener_planDesarrollo = function (dato) {
        $http({
          ...
          if (data && data.toString().substr(0, 3) != '<br') {
            if (data.Codigo == 0 && dato == 'P') {
              swal({
                title: "!Info¡",
                text: 'No hay'+ " " + " " + 'evaluacion inferiores al 80%',
                type: "info",
              }).catch(swal.noop);
              return
            } if (data.Codigo == 0 && dato == 'C') {
                swal({
                  title: "!Info¡",
                  text: 'No hay' + " " + " " + 'evaluacion superiores al 80%',
                  type: "info",
                }).catch(swal.noop);
                return
      ...
      $scope.Set_Tab = function (x) {
        ...
        if (x == 2) {
          $scope.p_obtener_planDesarrollo('P');
          // if($scope.validacionlistdeEvaluaciones < 0 || $scope.validacionlistdeEvaluaciones == undefined ){
          //   swal({
          //     title: "ATENCION",
          //     text: "En estos momentos no cuentas con ninguna evaluacion para realizar gestion",
          //     type: "warning"
          //   }).catch(swal.noop);
          //   setTimeout(() => {
          //     $('#tabs_1').click();
